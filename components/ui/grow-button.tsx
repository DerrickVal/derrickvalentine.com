...
function SecondaryGrowButton(props: GrowButtonProps) {
  ...
  return (
    <Button
      ...
      asChild={asChild}
      className={cn(
        'text-primary cursor-pointer rounded-lg border border-[color-mix(in_oklab,var(--primary)_30%,var(--card))] bg-[color-mix(in_oklab,var(--primary)_10%,var(--card))] hover:bg-[color-mix(in_oklab,var(--primary)_15%,var(--card))] active:scale-95',
