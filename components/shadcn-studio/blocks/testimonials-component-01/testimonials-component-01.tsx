    ...
    <section className='py-8 sm:py-16 lg:py-24'>
      ...
      >
        ...
        <div className='space-y-4 sm:w-1/2 lg:w-1/3'>
          <p className='text-primary text-sm font-medium uppercase'>In their words</p>

          <h2 className='text-2xl font-semibold sm:text-3xl lg:text-4xl'>What it&apos;s like to work with me</h2>

          <p className='text-muted-foreground text-xl'>
            Real clients on what it&apos;s actually like to hand me the website.
          </p>
